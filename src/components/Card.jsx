...
function Card() {
  ...
  const handleGetInfo = () => {
    ...
    setUserId(username);
    // Implement your logic to get info based on username if needed
  };

  const handleKeyDown = (event) => {
    if (event.key === 'Enter') {
      setUserId(username); // Update UserId with current username
    }
  };
  ...
  return (
    ...
    <div className="flex justify-center items-center lg:m-0 m-5">
      <div className="w-80 min-w-[9cm] p-8 bg-white rounded-lg border-2 border-gray-500 shadow-xl shadow-gray-900 hover:shadow-gray-950"> {/* Apply custom shadow-white class */}
     ...
     <div className='fixed top-0 right-0 p-4'>
            ...
            <a href=' https://www.linkedin.com/in/kunal-bodke-b29663252'> <FaLinkedin  /></a>
